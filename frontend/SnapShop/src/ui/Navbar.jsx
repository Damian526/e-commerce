...
function Navbar() {
    ...
    return  (
        <header className="py-4 bg-white dark:bg-slate-800 sticky top-0 z-10 shadow-lg font-karla">
          <div className="container mx-auto px-4">
            <div className="flex justify-between items-center">
              ...
              <nav className="flex gap-4 md:gap-8 items-center dark:text-white" aria-label="Main Navigation">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div className="text-gray-500 text-2xl">
                    {username === "" && (
                      <span className="cursor-pointer hover:opacity-85 dark:text-white">
                        Login
                      </span>
                    )}
                  </div>
                ...
                <div className="relative">
                  <Link to="/cart" className="text-2xl text-gray-500 dark:text-white" aria-label="View Cart">
                    <BsCart />
                  </Link>
